...
st.write ("""
### Other Algorithms for Predicting Outcome of Pediatric Traumatic Brain Injury 

""")

st.markdown( "  [SVM] (https://ct-pedtbi-test-svm.herokuapp.com/) ")
st.markdown( "  [Neural Network] (https://ct-pedtbi-test-nn.herokuapp.com/) ")
st.markdown( "  [Logistic Regression] (https://ct-pedtbi-test-lr.herokuapp.com/) ")
#st.markdown( "  [kNN] (https://ct-pedtbi-test-knn.herokuapp.com/) ")
...
st.markdown( "  [Nomogram] (https://thara.shinyapps.io/ct-pedtbi-nomogram/) ")
